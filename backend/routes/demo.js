...
let telechargement = require('../models/demo.model'); //pour exiger le model 
...
//Cette section n'est pas nécessaire, elle est utilisée pour ajouter des données dans la base de données
